...
<body>
	...
	<div id="navbar">
	  ...
	  <% } %>
	   <% if(id==0){ %>
	  <a href="../HTML/register.html">New Registration</a>
	  <%}else if(isAdmin){ %>
	    <a href="../HTML/adminControl.html">Administration Controls</a>
	  <%} %>
	    <a href="../logout">Logout</a>
	</div>
	 <%
	  if(id>0 &&  !isAdmin){ %><p>Available Balance <span>&#8669;</span> <%=userDetails.getBalance(id) %></p><%} %>
	<div>
